    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Learning Styles at a Glance</h2>
              <p className="text-gray-600 text-sm">
                Explore different learning modes while we finish the assessment experience.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="card text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-1">Auditory Learning</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="card text-center sm:col-span-2 lg:col-span-1">
                ...
                <h3 className="font-semibold text-gray-900 mb-1">Kinesthetic Learning</h3>
                <p className="text-sm text-gray-600">
